...
![The Crawl, Walk, Run, Fly infographic — a four-stage AI adoption framework for agencies, built as an HTML page by Claude Code](../../assets/images/blog/crawl-walk-run-fly.png)
<p class="image-caption">The infographic from that session, built entirely by Claude Code.</p>
